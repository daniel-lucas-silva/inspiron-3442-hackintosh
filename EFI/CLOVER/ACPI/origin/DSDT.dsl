 ...
 *
 * Disassembly of DSDT.aml, Thu Jun 21 09:28:53 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000105E0 (67040)
 *     Revision         0x02
 *     Checksum         0x06
 *     OEM ID           "DELL"
 *     OEM Table ID     "WN09"
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "DELL", "WN09", 0x00000000)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCB568C18, 0x02B2)
    ...
    OperationRegion (EXBU, SystemMemory, 0xCB56A018, 0x104D)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCABA4E18, 0x10)
    ...
    OperationRegion (DEBU, SystemMemory, 0xCB56CF18, 0x0004)
