 ...
 *
 * Disassembly of SSDT-10.aml, Thu Jun 21 09:28:53 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000194E (6478)
 *     Revision         0x01
 *     Checksum         0x69
 *     OEM ID           "OptRef"
...
DefinitionBlock ("SSDT-10.aml", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP05.TGPC, BuffObj)
    ...
    External (FBSB, IntObj)
    External (GC6S, FieldUnitObj)
    External (GESB, IntObj)
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            SGPO (GESB, One)
            While (LNotEqual (SGPI (FBSB), Zero))
            {
                Sleep (One)
            }
